 ...
 *  version 2.1 of the License, or (at your option) any later version.
	...
	*| Modified August 21 2013 by TDW		|*
	*| twoodbury@tamu.edu					|*
	*| Supports the FHP_airspeed object 	|*
	*| for using the five hole probe on 	|*
	*| Pegasus 1 for airspeed 				|*
	*| calculation. This class 				|*
	*| definition is NO LONGER COMPATIBLE	|*
	*| with vanilla APM code, or the 		|*
	*| standard Pitot-static probe.			|*
...
public:
    ...
    void            set_airspeed(FHP_Airspeed *airspeed) {
        _airspeed = airspeed;
    }
